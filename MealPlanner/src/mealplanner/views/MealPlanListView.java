...
public class MealPlanListView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "recipe1", "recipe2" };
        ...
        jList3.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "recipe 1", "recipe 2", "recipe 3" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane3.setViewportView(jList3);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "4/21/2021", "4/22/2021", "4/23/2021" }));
